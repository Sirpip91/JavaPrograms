...
class Result {
    ...
    public static int equalStacks(List<Integer> h1, List<Integer> h2, List<Integer> h3) {
        ...
        //create three stacks st1 st2 st3
    Stack<Integer> st1 = new Stack<>();
    Stack<Integer> st2 = new Stack<>();
    Stack<Integer> st3 = new Stack<>();
        //store the maxheight
    int maxHeight = 0;
        //go through the first List and push needed
    for(int i=h1.size()-1; i>=0; i--){
      if(st1.isEmpty()){
        ...
        //go trhough second list and push needed
    for(int i=h2.size()-1; i>=0; i--){
      if(st2.isEmpty()){
        ...
        //go through third list and push needed
    ...
    while(!st1.isEmpty()&&!st2.isEmpty()&&!st3.isEmpty()){
      ...
      if(stack1Height>stack2Height||stack1Height>stack3Height){
        ...
        // return the max height of the three
    return maxHeight;
    }
